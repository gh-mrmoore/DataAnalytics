...
-- 133776 rows returned
-- some inactive employees
-- 72458 rows when filtering on to_date
...
-- WHERE crt.to_date = '9999-01-01'
ORDER BY emp_no ASC, to_date DESC;
-- 90398 rows returned
-- still some inactive employees included in the query
-- 72458 rows when including only active employees
